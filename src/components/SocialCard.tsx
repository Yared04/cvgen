...
export const SocialCardRow = ({ title, url, logoUrl}: SocialRowProps) => {
  return (
    ...
    <h2 className="flex text-text-secondary text-sm mb-4 max-w-[200px] overflow-wrap break-all">{url}</h2>
</div>
      </div>
...
export const SocialCard = ({linkedIn,github,other } : SocialCardProps) => {
    return (
        <div className="border-2 p-8 rounded-md">
            ...
            <SocialCardRow title={"LinkedIn"} logoUrl={"https://th.bing.com/th/id/OIP.b5oDvUVU5UVN4cefTJGq3wHaHa?pid=ImgDet&rs=1"} url={linkedIn}></SocialCardRow>
            <SocialCardRow title={"GitHub"} logoUrl={"https://pngimg.com/uploads/github/github_PNG40.png"} url={github}></SocialCardRow>
            <SocialCardRow title={"Other Links"} logoUrl={"https://icon-library.com/images/link-icon-svg/link-icon-svg-2.jpg"} url={other}></SocialCardRow>

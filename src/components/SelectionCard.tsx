...
export const SelectionCard = ({ name, hasDetails, detailsOn }: SelectionCardProps) => {
  ...
  return (
    <div className="flex-col w-[50%] shadow m-4 p-4 rounded-sm h-fit" >
      <p className="mb-6 text-lg text-primary text-xl font-bold" onClick={toggleDetails}>{name}</p>
